...
export default function PrivacyPolicyPage() {
  ...
  useEffect(() => {
    ...
    settingsService.get().then(s => {
      if (s?.privacyPolicyContent) setContent(s.privacyPolicyContent)
    }).catch(() => {})
  }, [])
    ...
    <div className="font-poppins bg-[#f7f9fc] min-h-screen">
      ...
      <div className="px-4 pt-10 pb-20 sm:pt-14 sm:pb-28" style={{ background: 'linear-gradient(135deg, #1655c3, #64ac37)' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-white font-black text-3xl sm:text-4xl lg:text-5xl leading-tight">Privacy Policy</h1>
        </div>
      </div>
